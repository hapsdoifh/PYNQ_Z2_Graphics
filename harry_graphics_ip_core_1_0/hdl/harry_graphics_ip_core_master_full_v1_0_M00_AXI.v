...
`timescale 1 ns / 1 ps
	...
	module harry_graphics_ip_core_master_full_v1_0_M00_AXI #
	(
	...
	(
        ...
        input wire [31:0] input_data2,
        input wire [31:0] input_data3,
        input wire [31:0] input_data4,
        
        input wire input_wvalid,
        input wire input_ack,
        
        
        output wire [31:0] output_data0,
        output wire [31:0] output_data1,
        output wire [31:0] output_data2,
        output wire [31:0] output_data3,
        
        output wire output_wvalid,
        output wire output_ack,
...
//	assign M_AXI_AWADDR	= C_M_TARGET_SLAVE_BASE_ADDR + axi_awaddr;
	assign M_AXI_AWADDR	= C_M_TARGET_SLAVE_BASE_ADDR + axi_awaddr + input_data4;
...
//	    else if (M_AXI_BVALID && (&write_burst_counter[C_NO_BURSTS_REQ-1:0]) && axi_bready)                    
	...
	always @(posedge M_AXI_ACLK) begin
	   ...
	   else if(read_ack_stage2) begin
	       wvalid_out <= 0;
	   end
	   if(input_wvalid) begin
	       reg0_in <= input_data0;
	       reg1_in <= input_data1;
	       reg2_in <= input_data2;
	       reg3_in <= input_data3;
